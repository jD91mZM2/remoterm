...
fn inner_main() -> Result<(), Error> {
    ...
    builder.set_verify_callback(SSL_VERIFY_PEER, move |_, cert| {
        use std::fmt::Write;
    ...
    let mut stream =
ssl.danger_connect_without_providing_domain_for_certificate_verification_and_server_name_indication(stream)?;
